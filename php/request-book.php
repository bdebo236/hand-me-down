<html>
    <head>
        <title>Request A Book - Hand Me Down</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <!-- AJAX -->
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        <!-- My Scripts and Links -->
        <script src="../js/request-book.js"></script>
    ...
    <body onload="typeWrite()">
                        ...
                        <li class="nav-item">
                            <?php 
                                ...
                                if(isset($_SESSION['username'])) {
                                    echo '<a href="#" class="nav-link active">Request</a>';
                                } else {
        ...
        <section>
            <div class="container">
                <div class="heading">
                    <h2><span class="first-letter">R</span>equest <span class="first-letter">a</span> <span class="first-letter">b</span>ook</h2>
                    <div id="subheader">
                ...
                <div class="search-wrap">
                    <input type="text" name="bookName" id="bookName" placeholder="What do you wanna request?">
