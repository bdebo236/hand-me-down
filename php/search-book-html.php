<html>
    <head>
        <title>Search Books - Hand Me Down</title>
    ...
    <body onload="typeWrite()">
        ...
        <section>
            <div class="container"> 
                <div class="heading">
                    <h2><span class="first-letter">s</span>earch <span class="first-letter">b</span>ooks</h2>
                    <div id="subheader">
                        <span id="description"></span>
                        <span id="cursor">_</span>
                    </div>
                </div>
                <div class="info">Click On Seller To Start Talking!</div>
                <!-- Title Ends -->

                <div class="search-wrap">
                    <input type="text" name="bookName" id="bookName" placeholder="Search by Title or Author">
